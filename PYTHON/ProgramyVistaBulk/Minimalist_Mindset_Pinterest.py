...
path = f"S:\\ARCHIWUM\\Minimalist Mindset\\Minimalist Quotes and Affirmations"
...
def tworzenie_pliku_excel():
    ...
    for i in range(19):
        ...
        link_path = f"http://hosting2275851.online.pro/ARCHIWUM/Minimalist Mindset/{sciezka}/{i+1}.mp4"
