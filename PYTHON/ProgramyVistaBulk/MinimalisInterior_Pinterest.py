...
def tworzenie_pliku_excel():
    xlsx_file_path = "C:\\PROGRAMOWANIE\\PYTHON\\GotoweVistaBulk\\MinimalistInterior_Pinterest.xlsx"
    ...
    for i in range(ilosc_postow):
        ...
        link_path = f"http://hosting2303687.online.pro/ARCHIWUM/MinimalistInterior/pinterest/livingroom/{i+1}.jpg"
...
def convert_xlsx_to_csv():
    df = pd.read_excel("C:\\PROGRAMOWANIE\\PYTHON\\GotoweVistaBulk\\MinimalistInterior_Pinterest.xlsx")

    df.to_csv("C:\\PROGRAMOWANIE\\PYTHON\\GotoweVistaBulk\\MinimalistInterior_Pinterest.csv", index=False)
